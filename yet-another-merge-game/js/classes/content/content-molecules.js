class ContentMolecules {
    constructor() {
        ...
        this.molecules = [
            ...
            new Molecule("C₆ - Carbon Ring", "images/tabs/molecules.png", new Decimal(1e93), 650, level => Decimal.pow(16384, level ** 1.25).mul(4)),
        ...
        this.upgrades = {
            ...
            fasterEnergyCores: new MoleculeUpgrade("Faster Energy Cores", "Energy Cores will take less Merges to Level up",
                level => Decimal.pow(1e3, level ** 3 + 3),
                level => Decimal.pow(0.99, level), {
                maxLevel: 100,
                getEffectDisplay: effectDisplayTemplates.numberStandard("x", "", 2, 3)
            }),
            moreIsotopes: new MoleculeUpgrade("Isotope Multiplier", "Finally, it's time to really get them going!",
            ...
            fasterMolecules: new MoleculeUpgrade("Faster Molecules", "Molecules will take less merges to level up.",
