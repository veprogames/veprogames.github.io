Vue.component("processor-core", {
    ...
    <div class="info">
        ...
        <button class="buy with-icon" v-if="hasCores" :disabled="!canAfford" @click="core.upgrade()"><img alt="ISO" src="images/currencies/isotopes.png"/> {{core.getCurrentPrice() | ftnum}}</button>
    </div>
</div>`
});